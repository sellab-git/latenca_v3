...
1. Use the native content-search tool (e.g., Grep) to find code related to the feature area -- components, hooks, services, routes, existing tests
2. Use the native file-search tool (e.g., Glob) to find related features that may share patterns or integrate with this one
